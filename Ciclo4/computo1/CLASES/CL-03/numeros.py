...
#Elevamos a  X potencia
#Se usa el operador ** para elevar un numero a una potencia
#El str() convierte el resultado de la operacion a un string para anexarlo al mensaje
